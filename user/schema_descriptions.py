...
logout_schema = {
    ...
    "description": (
        "Accepts a refresh token and blacklists it, effectively logging the user out.\n\n"
        "📥 **Request Body**:\n"
        "```json\n"
...
user_list_schema = {
    ...
    "description": "Returns a list of users. Supports search by email, first name, or last name.",
    "parameters": [
        OpenApiParameter("search", str, OpenApiParameter.QUERY, description="Search query")
    ],
...
follow_schema = {
    ...
    "description": "Send POST to follow a user and DELETE to unfollow. Can't follow yourself.",
    "tags": ["follows"],
    "responses": {
        201: None,
        204: None,
...
followers_list_schema = {
    ...
    "description": "Returns a list of users that are following the current user.",
